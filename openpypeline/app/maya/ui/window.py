...
class window():
    ...
    def __init__(self):
        '''
        Name: window.py
        Description: Base-class for openPypeline Studio Maya Windows. The purpose of this class is to avoid writing redundant Maya UI functionality into every Maya GUI. For example, deleting a duplicate UI before building a new one. 
        ...
        self.prettyName = (string) example: 'openPypeline Studio'
