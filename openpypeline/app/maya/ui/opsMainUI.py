...
class opsMainUI(window.window):
    ...
    def _build_top_menu(self):
        ...
        self.ops_topDropDownAddOns_menuItem2 = cmds.menuItem('ops_topDropDownAddOns_menuItem2', parent=self.ops_topDropDownAddOns_menu, label="How to add to this menu...", c='openPipelineAddonsDialog')
        
        self.ops_topDropDownHelp_menu = cmds.menu(label="Help", parent=self.ops_topDropDown_menuBarLayout, helpMenu=1)
        self.ops_topDropDown_menuItem1 = cmds.menuItem('ops_topDropDown_menuItem1', parent=self.ops_topDropDownHelp_menu, label="About openPipeline...", command="openPipelineAboutDialog")
        self.ops_topDropDown_menuItem2 = cmds.menuItem('ops_topDropDown_menuItem2', parent=self.ops_topDropDownHelp_menu, label="Help...", command="openPipelineHelpLaunch")
    ...
    def _build_basic_info(self):
        ...
        self.ops_userName_optionMenu = cmds.optionMenu('ops_userName_optionMenu', parent=self.ops_form1, cc="openPipelineUpdateUser", enable=0)
        
        self.ops_projName_txt = cmds.text('ops_projName_txt', parent=self.ops_form1, al="right", label="Project Name : ", w=150)
        self.ops_projManager_btn = cmds.button('ops_projManager_btn', parent=self.ops_form1, label="Project Manager...", c="openPipelineProjectUI", ann=self.anno_projectManager, h=30)
        self.ops_projName_optionMenu = cmds.optionMenu('ops_projName_optionMenu', parent=self.ops_form1, cc="openPipelineProjSelected 1", ann=self.anno_projectList)
    ...
    def _build_bottom_buttons(self):
        ...
        self.ops_refreshUIButton = cmds.button(h=30, label="Refresh UI", command="openPipelineUI")
        self.ops_closeUIButton = cmds.button(h=30, label="Close", command="openPipelineCloseUI", ann=self.anno_close)
        cmds.formLayout(
