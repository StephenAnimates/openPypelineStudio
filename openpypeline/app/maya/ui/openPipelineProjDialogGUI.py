"""
Module: openPypelineProjDialogGUI.py
...
class openPypelineProjDialogGUI(window.window):
...
#    def __init__(self, mode):
    ...
    def content(self):
        ...
        """
        self.form1 = cmds.formLayout('openPypelineprojDialogGUI_form', numberOfDivisions=100)
