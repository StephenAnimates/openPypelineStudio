"""
Module: openPypelineMainUI.py

Description: 
    Creates and manages the main openPypeline Studio UI in Maya.
    This module defines the `openPypelineMainUI` class, which inherits from 
...
def _tr(text):
    """
    Dummy translation wrapper to prepare for PySide6 / Qt Linguist.
    When the PySide6 migration happens, this can easily be replaced with
    native `self.tr()` or `QtCore.QCoreApplication.translate()`.
    """
    return text

class openPypelineMainUI(window.window):
    ...
    def __init__(self):
        ...
        self.op_icon_filePath = os.path.join(ui_dir, 'openPypelineIcon.png').replace("\\", "/")
    ...
    def _build_basic_info(self):
        ...
        self.op_projManager_btn = cmds.button('op_projManager_btn', parent=self.op_form1, label="Project Manager...", c="openPipelineProjectUI", ann=_tr("Open the Project Manager, where you can add or remove Projects."), h=30)
        self.op_projName_optionMenu = cmds.optionMenu('op_projName_optionMenu', parent=self.op_form1, cc="openPipelineProjSelected 1", ann=_tr("Select from the available Projects."))
    ...
    def _build_currently_open_tab(self):
        ...
        self.op_currOpenSaveWorkshop_btn = cmds.button('op_currOpenSaveWorkshop_btn', parent=self.op_currOpen_formLayout, l="Save Workshop...", w=164, bgc=(.8, .6, .5), c="openPipelineSaveWorkshopGUI", ann=_tr("Save a workshop file for the current Asset/Shot/Component."))
        self.op_currOpenMaster_btn = cmds.button('op_currOpenMaster_btn', parent=self.op_currOpen_formLayout, l="MASTER...", w=164, bgc=(.9, .7, .4), c="openPipelineSaveMasterFileGUI", ann=_tr("Save a master file for the current Asset/Shot/Component."))
        self.op_currOpenRevive_btn = cmds.button('op_currOpenRevive_btn', parent=self.op_currOpen_formLayout, l="Revive...", bgc=(.5, .7, .7), w=82, c="openPipelineReviveGUI", ann=_tr("Revive an old version of the current Asset/Shot/Component."))
        self.op_currOpenClose_btn = cmds.button('op_currOpenClose_btn', parent=self.op_currOpen_formLayout, l="Close", bgc=(.8, .8, .8), c="openPipelineCloseCurrent", ann=_tr("Close the currently open file."))
    ...
    def _build_asset_browser_tab(self):
        ...
        self.op_assetType_txtScrollList = cmds.textScrollList('op_assetType_txtScrollList', parent=self.op_shotSequence_formLayout, h=119, ams=0, sc="openPipelineUpdateAssetList 0", fn="smallPlainLabelFont", ann=_tr("Choose an Asset Type."))
        self.op_assetTypeNew_btn = cmds.button('op_assetTypeNew_btn', parent=self.op_shotSequence_formLayout, l="New...", bgc=(.6, .8, .5), c="openPipelineNewAssetTypeUI", ann=_tr("Create a new Asset Type"))
        self.op_assetTypeRemove_btn = cmds.button('op_assetTypeRemove_btn', parent=self.op_shotSequence_formLayout, l="Delete", bgc=(.8, .3, .3), c="openPipelineRemoveProcess 2 1", ann=_tr("Remove the selected Asset Type(s) from the inventory."))
        ...
        self.op_assetActions_editAsset_menuItem = cmds.menuItem('op_assetActions_EditAsset_menuItem', parent=self.op_assetActions_menu, label="Edit Asset", subMenu=0, command="openPipelineOpenCurrentlySelected 2 2 workshop 0", ann=_tr("Open the Asset for editing."))
        self.op_assetActions_openMaster_menuItem = cmds.menuItem('op_assetActions_OpenMaster_menuItem', parent=self.op_assetActions_menu, label="Open Master", subMenu=0, command="openPipelineOpenCurrentlySelected 2 2 master 0", ann=_tr("Open the master file for the Asset."))
        ...
        self.op_assetActions_importWorkshop_menuItem = cmds.menuItem('op_assetActions_workshop_menuItem', parent=self.op_assetActions_import_menuItem, label="Workshop", command="openPipelineImportUI 0 asset workshop", ann=_tr("Import the Asset's latest workshop file into the current scene."))
        ...
        self.op_assetActions_importMaster_menuItem = cmds.menuItem('op_assetActions_importMaster_menuItem', parent=self.op_assetActions_import_menuItem, label="Master", command="openPipelineImportUI 0 asset master", ann=_tr("Import the Asset's master file into the current scene."))
        ...
        self.op_assetActions_referenceWorkshop_menuItem = cmds.menuItem('op_assetActions_referenceWorkshop_menuItem', parent=self.op_assetActions_reference_menuItem, label="Workshop", command="openPipelineReferenceUI 0 asset workshop", ann=_tr("Reference the Asset's latest workshop file into the current scene."))
        ...
        self.op_assetActions_referenceMaster_menuItem = cmds.menuItem('op_assetActions_referenceMaster_menuItem', parent=self.op_assetActions_reference_menuItem, label="Master", command="openPipelineReferenceUI 0 asset master", ann=_tr("Reference the Asset's master file into the current scene."))
        ...
        self.op_asset_scrollList = cmds.textScrollList(w=125, h=100, dcc="openPipelineOpenCurrentlySelected 2 2 workshop 0", sc="openPipelineAssetSelected 0", fn="smallPlainLabelFont", ann=_tr("Double-click to edit Asset. Hold right mouse button for more options."))
        self.op_assetpopUpMenu = cmds.popupMenu(p=self.op_asset_scrollList, b=3, mm=1, pmc="openPipelineAssetSelected 1")
        self.op_assetPopUpMenu_editAsset_menuItem = cmds.menuItem(parent=self.op_assetpopUpMenu, label="Edit Asset", command="openPipelineOpenCurrentlySelected 2 2 workshop 0", ann=_tr("Open the Asset for editing."))
        
        self.op_assetPopUpMenu_openMaster_menuItem = cmds.menuItem(parent=self.op_assetpopUpMenu, label="Open Master", command="openPipelineOpenCurrentlySelected 2 2 master 0", ann=_tr("Open the master file for the Asset."))
        self.op_assetPopUpMenu_import_menuItem = cmds.menuItem(parent=self.op_assetpopUpMenu, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_assetPopUpMenu_workshop_menuItem = cmds.menuItem(parent=self.op_assetPopUpMenu_import_menuItem, label="Workshop", command="openPipelineImportUI 0 asset workshop", ann=_tr("Import the Asset's latest workshop file into the current scene."))
        ...
        self.op_assetPopUpMenu_master_menuItem = cmds.menuItem(parent=self.op_assetPopUpMenu_import_menuItem, label="Master", command="openPipelineImportUI 0 asset master", ann=_tr("Import the Asset's master file into the current scene."))
        ...
        self.op_assetPopUpMenu_referenceWorkshop_menuItem = cmds.menuItem(parent=self.op_assetPopUpMenu_reference_menuItem, label="Workshop", command="openPipelineReferenceUI 0 asset workshop", ann=_tr("Reference the Asset's latest workshop file into the current scene."))
        ...
        self.op_assetPopUpMenu_referenceMaster_menuItem = cmds.menuItem(parent=self.op_assetPopUpMenu_reference_menuItem, label="Master", command="openPipelineReferenceUI 0 asset master", ann=_tr("Reference the Asset's master file into the current scene."))
        ...
        self.op_assetNew_btn = cmds.button(parent=self.op_assetAssetTypes_formLayout, l="New...", bgc=(.6, .8, .5), w=65, c="openPipelineNewAssetUI", ann=_tr("Open the Asset for editing."))
        self.op_assetRemove_btn = cmds.button(parent=self.op_assetAssetTypes_formLayout, l="Delete", bgc=(.8, .3, .3), w=60, c="openPipelineRemoveProcess 2 2", ann=_tr("Remove the selected Asset from the inventory."))
        self.op_assetRename_btn = cmds.button(parent=self.op_assetAssetTypes_formLayout, l="Rename...", bgc=(.6, .8, .5), w=65, c="openPipelineRenameAssetUI", ann=_tr("Rename the selected Asset."))
        ...
        self.op_compMenuEdit = cmds.menuItem(parent=self.op_assetComponentMenu, label="Edit Component", subMenu=0, command="openPipelineOpenCurrentlySelected 2 3 workshop 0", ann=_tr("Open the Component for editing."))
        self.op_compMenuView = cmds.menuItem(parent=self.op_assetComponentMenu, label="View Master", command="openPipelineOpenCurrentlySelected 2 3 master 0" , ann=_tr("Open the master file for the Component."))
        
        self.op_compMenuImport = cmds.menuItem(parent=self.op_assetComponentMenu, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_compMenuImportWorkshop = cmds.menuItem(parent=self.op_compMenuImport, label="Workshop",command="openPipelineImportUI 0 component workshop", ann=_tr("Import the Component's latest workshop file into the current scene."))
        self.op_compMenuImportWorkshopOpBox = cmds.menuItem(ob=1, c="openPipelineImportUI 1 component workshop")
        self.op_compMenuImportMaster = cmds.menuItem( parent=self.op_compMenuImport, label="Master", command="openPipelineImportUI 0 component master", ann=_tr("Import the Component's master file into the current scene."))
        ...
        self.op_compMenuReferenceWorkshop = cmds.menuItem(parent=self.op_compMenuReference, label="Workshop", command="openPipelineReferenceUI 0 component workshop", ann=_tr("Reference the Component's latest workshop file into the current scene."))
        self.op_compMenuReferenceWorkshopOpBox = cmds.menuItem(ob=1, c="openPipelineReferenceUI 1 component workshop")
        self.op_compMenuReferenceMaster = cmds.menuItem(parent=self.op_compMenuReference, label="Master", command="openPipelineReferenceUI 0 component master", ann=_tr("Reference the Component's master file into the current scene."))
        ...
        self.op_componentScrollList = cmds.textScrollList(parent=self.op_assetColumnLayout02, w=125, h=100, en=0, dcc="openPipelineOpenCurrentlySelected 2 3 workshop 0", sc="openPipelineComponentSelected", fn="smallPlainLabelFont", ann=_tr("Double-click to edit Component. Hold down right mouse button for more options."))
        self.op_assetPopupMenu02 = cmds.popupMenu(parent=self.op_componentScrollList, b=3, mm=1, pmc="openPipelineComponentSelected")
        self.op_compMenuEdit2 = cmds.menuItem(parent=self.op_assetPopupMenu02, label="Edit Component", subMenu=0, command="openPipelineOpenCurrentlySelected 2 3 workshop 0", ann=_tr("Open the Component for editing."))
        self.op_compMenuView2 = cmds.menuItem(parent=self.op_assetPopupMenu02, label="View Master", command="openPipelineOpenCurrentlySelected 2 3 master 0", ann=_tr("Open the master file for the Component."))
        
        self.op_compMenuImport2 = cmds.menuItem(parent=self.op_assetPopupMenu02, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_compMenuImportWorkshop2 = cmds.menuItem(parent=self.op_compMenuImport2, label="Workshop", command="openPipelineImportUI 0 component workshop", ann=_tr("Import the Component's latest workshop file into the current scene."))
        self.op_compMenuImportWorkshopOpBox2 = cmds.menuItem(ob=1, c="openPipelineImportUI 1 component workshop")
        self.op_compMenuImportMaster2 = cmds.menuItem(parent=self.op_compMenuImport2, label="Master", command="openPipelineImportUI 0 component master", ann=_tr("Import the Component's master file into the current scene."))
        ...
        self.op_compMenuReferenceWorkshop2 = cmds.menuItem(parent=self.op_compMenuReference2, label="Workshop", command="openPipelineReferenceUI 0 component workshop", ann=_tr("Reference the Component's latest workshop file into the current scene."))
        self.op_compMenuReferenceWorkshopOpBox2 = cmds.menuItem(ob=1, c="openPipelineReferenceUI 1 component workshop")
        self.op_compMenuReferenceMaster2 = cmds.menuItem(parent=self.op_compMenuReference2, label="Master", command="openPipelineReferenceUI 0 component master", ann=_tr("Reference the Component's master file into the current scene."))
        ...
        self.op_componentNewButton = cmds.button(parent=self.op_assetSubFormLayout02, l="New...", bgc=(.6, .8, .5), w=65, c="openPipelineNewAssetComponentUI", ann=_tr("Create a new Component for the selected Asset."))
        self.op_componentRemoveButton = cmds.button(parent=self.op_assetSubFormLayout02, l="Delete", bgc=(.8, .3, .3), w=60, c="openPipelineRemoveProcess 2 3", ann=_tr("Remove the selected Component from the inventory."))
    ...
    def _build_shot_browser_tab(self):
        ...
        self.op_sequenceScrollList = cmds.textScrollList(parent=self.op_shotSequenceFormLayout, w=125, h=119, ams=0, sc="openPipelineUpdateShotList 0", fn="smallPlainLabelFont", ann=_tr("Choose a Sequence."))
        self.op_assetTypeNewButton = cmds.button(parent=self.op_shotSequenceFormLayout, l="New...", bgc=(.6, .8, .5), w=65, c="openPipelineNewSequenceUI", ann=_tr("Create a new Sequence"))
        self.op_sequenceRemoveButton = cmds.button(parent=self.op_shotSequenceFormLayout, l="Delete", bgc=(.8, .3, .3), w=60, c="openPipelineRemoveProcess 3 1", ann=_tr("Remove the selected Sequence from the inventory."))
        ...
        self.op_shotMenuEdit = cmds.menuItem(parent=self.op_shotMenu, label="Edit Shot", subMenu=0, command="openPipelineOpenCurrentlySelected 3 2 workshop 0", ann=_tr("Open the Shot for editing."))
        self.op_shotMenuView = cmds.menuItem(parent=self.op_shotMenu, label="View Master", subMenu=0, command="openPipelineOpenCurrentlySelected 3 2 master 0", ann=_tr("Open the master file for the Shot."))
        
        self.op_shotMenuImport = cmds.menuItem(parent=self.op_shotMenu, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_shotMenuImportWorkshop = cmds.menuItem(parent=self.op_shotMenuImport, label="Workshop", command="openPipelineImportUI 0 shot workshop", ann=_tr("Import the Shot's latest workshop file into the current scene."))
        self.op_shotMenuImportWorkshopOpBox = cmds.menuItem(ob=1, c="openPipelineImportUI 1 shot workshop", en=0)
        self.op_shotMenuImportMaster = cmds.menuItem(parent=self.op_shotMenuImport, label="Master", command="openPipelineImportUI 0 shot master", ann=_tr("Import the Shot's master file into the current scene."))
        ...
        self.op_shotMenuReferenceWorkshop = cmds.menuItem(parent=self.op_shotMenuReference, label="Workshop", command="openPipelineReferenceUI 0 shot workshop", ann=_tr("Reference the Shot's latest workshop file into the current scene."))
        self.op_shotMenuReferenceWorkshopOpBox = cmds.menuItem(ob=1, c="openPipelineReferenceUI 1 shot workshop")
        self.op_shotMenuReferenceMaster = cmds.menuItem(parent=self.op_shotMenuReference, label="Master", command="openPipelineReferenceUI 0 shot master", ann=_tr("Reference the Shot's master file into the current scene."))
        ...
        self.op_shotScrollList = cmds.textScrollList(parent=self.op_shotColumnLayout01, w=125, h=100, dcc="openPipelineOpenCurrentlySelected 3 2 workshop 0", sc="openPipelineShotSelected 0", fn="smallPlainLabelFont", ann=_tr("Double-click to Edit Shot. Hold down right mouse button for more options."))
        
        self.op_shotPopupMenu01 = cmds.popupMenu(p=self.op_shotScrollList, b=3, mm=1, pmc="openPipelineShotSelected 0")
        
        self.op_shotMenuEdit2 = cmds.menuItem(parent=self.op_shotPopupMenu01, label="Edit Shot", command="openPipelineOpenCurrentlySelected 3 2 workshop 0", ann=_tr("Open the Shot for editing."))
        self.op_shotMenuView2 = cmds.menuItem(parent=self.op_shotPopupMenu01, label="View Master", command="openPipelineOpenCurrentlySelected 3 2 master 0", ann=_tr("Open the master file for the Shot."))
        
        self.op_shotMenuImport2 = cmds.menuItem(parent=self.op_shotPopupMenu01, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_shotMenuImportWorkshop2 = cmds.menuItem(parent=self.op_shotMenuImport2, label="Workshop", command="openPipelineImportUI 0 shot workshop", ann=_tr("Import the Shot's latest workshop file into the current scene."))
        self.op_shotMenuImportWorkshopOpBox2 = cmds.menuItem(ob=1, c="openPipelineImportUI 1 shot workshop")
        self.op_shotMenuImportMaster2 = cmds.menuItem(parent=self.op_shotMenuImport2, label="Master", command="openPipelineImportUI 0 shot master", ann=_tr("Import the Shot's master file into the current scene."))
        ...
        self.op_shotMenuReferenceWorkshop2 = cmds.menuItem(parent=self.op_shotMenuReference2, label="Workshop", command="openPipelineReferenceUI 0 shot workshop", ann=_tr("Reference the Shot's latest workshop file into the current scene."))
        self.op_shotMenuReferenceWorkshopOpBox2 = cmds.menuItem(ob=1, c="openPipelineReferenceUI 1 shot workshop")
        self.op_shotMenuReferenceMaster2 = cmds.menuItem(parent=self.op_shotMenuReference2, label="Master", command="openPipelineReferenceUI 0 shot master", ann=_tr("Reference the Shot's master file into the current scene."))
        ...
        self.op_shotNewButton = cmds.button(parent=self.op_shotSubFormLayout01, l="New...", bgc=(.6, .8, .5), w=65, c="openPipelineNewShotUI", ann=_tr("Create a new Shot."))
        self.op_shotRemoveButton = cmds.button(parent=self.op_shotSubFormLayout01, l="Delete", bgc=(.8, .3, .3), w=60, c="openPipelineRemoveProcess 3 2", ann=_tr("Remove the selected Shot."))
        cmds.formLayout(
        ...
        self.op_shotcompMenuEdit = cmds.menuItem(parent=self.op_shotComponentMenu, label="Edit Shot Component", subMenu=0, command="openPipelineOpenCurrentlySelected 3 3 workshop 0", ann=_tr("Open the Component for editing."))
        self.op_shotcompMenuView = cmds.menuItem(parent=self.op_shotComponentMenu, label="View Master", command="openPipelineOpenCurrentlySelected 3 3 master 0", ann=_tr("Open the master file for the Component."))
        
        self.op_shotcompMenuImport = cmds.menuItem(parent=self.op_shotComponentMenu, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_shotcompMenuImportWorkshop = cmds.menuItem(parent=self.op_shotcompMenuImport, label="Workshop", command="openPipelineImportUI 0 shotComponent workshop", ann=_tr("Import the Component's latest workshop file into the current scene."))
        self.op_shotcompMenuImportWorkshopOpBox = cmds.menuItem(ob=1, c="openPipelineImportUI 1 shotComponent workshop")
        self.op_shotcompMenuImportMaster = cmds.menuItem(parent=self.op_shotcompMenuImport, label="Master", command="openPipelineImportUI 0 shotComponent master", ann=_tr("Import the Component's master file into the current scene."))
        ...
        self.op_shotcompMenuReferenceWorkshop = cmds.menuItem(parent=self.op_shotcompMenuReference, label="Workshop", command="openPipelineReferenceUI 0 shotComponent workshop", ann=_tr("Reference the Component's latest workshop file into the current scene."))
        self.op_shotcompMenuReferenceWorkshopOpBox = cmds.menuItem(ob=1, c="openPipelineReferenceUI 1 shotComponent workshop")
        self.op_shotcompMenuReferenceMaster = cmds.menuItem(parent=self.op_shotcompMenuReference, label="Master", command="openPipelineReferenceUI 0 shotComponent master", ann=_tr("Reference the Component's master file into the current scene."))
        ...
        self.op_shotComponentScrollList = cmds.textScrollList(parent=self.op_shotColumnLayout02, w=125, h=100, en=0, dcc="openPipelineOpenCurrentlySelected 3 3 workshop 0", sc="openPipelineShotComponentSelected", fn="smallPlainLabelFont", ann=_tr("Double-click to edit Component. Hold down right mouse button for more options."))

        self.op_shotPopupMenu02 = cmds.popupMenu(p=self.op_shotComponentScrollList, b=3, mm=1, pmc="openPipelineShotComponentSelected")
        
        self.op_shotcompMenuEdit2 = cmds.menuItem(p=self.op_shotPopupMenu02, label="Edit Shot Component", subMenu=0, command="openPipelineOpenCurrentlySelected 3 3 workshop 0", ann=_tr("Open the Component for editing."))
        self.op_shotcompMenuView2 = cmds.menuItem(p=self.op_shotPopupMenu02, label="View Master", command="openPipelineOpenCurrentlySelected 3 3 master 0", ann=_tr("Open the master file for the Component."))
        
        self.op_shotcompMenuImport2 = cmds.menuItem(p=self.op_shotPopupMenu02, label="Import", aob=1, subMenu=1, ann=" ")
        self.op_shotcompMenuImportWorkshop2 = cmds.menuItem(parent=self.op_shotcompMenuImport2, label="Workshop", command="openPipelineImportUI 0 shotComponent workshop", ann=_tr("Import the Component's latest workshop file into the current scene."))
        self.op_shotcompMenuImportWorkshopOpBox2 = cmds.menuItem(ob=1, c="openPipelineImportUI 1 shotComponent workshop")
        self.op_shotcompMenuImportMaster2 = cmds.menuItem(parent=self.op_shotcompMenuImport2, label="Master", command="openPipelineImportUI 0 shotComponent master", ann=_tr("Import the Component's master file into the current scene."))
        ...
        self.op_shotcompMenuReferenceWorkshop2 = cmds.menuItem(parent=self.op_shotcompMenuReference2, label="Workshop", command="openPipelineReferenceUI 0 shotComponent workshop", ann=_tr("Reference the Component's latest workshop file into the current scene."))
        self.op_shotcompMenuReferenceWorkshopOpBox2 = cmds.menuItem(ob=1, c="openPipelineReferenceUI 1 shotComponent workshop")
        self.op_shotcompMenuReferenceMaster2 = cmds.menuItem(parent=self.op_shotcompMenuReference2, label="Master", command="openPipelineReferenceUI 0 shotComponent master", ann=_tr("Reference the Component's master file into the current scene."))
        ...
        self.op_shotComponentNewButton = cmds.button(parent=self.op_shotSubFormLayout02, l="New...", bgc=(.6, .8, .5), w=65, c="openPipelineNewShotComponentUI", ann=_tr("Create a new Component for the selected Asset."))
        self.op_shotComponentRemoveButton = cmds.button(parent=self.op_shotSubFormLayout02, l="Delete", bgc=(.8, .3, .3), w=60, c="openPipelineRemoveProcess 3 3", ann=_tr("Remove the selected Component from the inventory."))
    ...
    def _build_bottom_buttons(self):
        ...
        self.op_closeUIButton = cmds.button(h=30, label="Close", command="openPipelineCloseUI", ann=_tr("Close openPipeline."))
        cmds.formLayout(
