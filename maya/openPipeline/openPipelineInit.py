"""
File: openPipelineInit.py
Description: Initializes all of the optionVars and configurations for openPipeline.
             Refactored from openPipelineInit.mel to use modern Python libraries.
"""
...
OPENPIPELINE_NAME = "openPipeline"
OPENPIPELINE_VERSION = "1.0.0-alpha"
OPENPIPELINE_PROJ_LIST = "openPipeline_projects.xml"
OPENPIPELINE_ICON_FILENAME = "openPipelineIcon.png"
OPENPIPELINE_DEFAULT_PREVIEW_FILENAME = "defaultPreview.png"
OPENPIPELINE_NO_PREVIEW_FILENAME = "noPreview.png"


def openPipelineInitialize():
    """
    Initializes all of the optionVars for openPipeline.
    """
...
def openPipelineReset():
    """
    Resets all of the optionVars for openPipeline.
