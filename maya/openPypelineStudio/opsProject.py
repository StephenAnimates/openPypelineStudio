...
def proj_custom_users(*args):
    ...
    state = cmds.checkBox("ops_customUsers", query=True, value=True)
    if state:
        cmds.button("ops_projectUsersBtn", edit=True, enable=True)
    else:
        cmds.button("ops_projectUsersBtn", edit=True, enable=False)
...
def proj_set_users_prompt_set(*args):
    ...
    cmds.textField("ops_projectUsers", edit=True, text=",".join(users))
    cmds.deleteUI("openPipelineUsersPromptUI")