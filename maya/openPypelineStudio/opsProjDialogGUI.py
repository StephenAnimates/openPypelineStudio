...
#    def __init__(self, mode):
    ...
    def _build_master_files_section(self):
        ...
        cmds.menuItem(label="usd", parent=self.projDialogMasterFileFormat_optMenu)
        cmds.menuItem(label="usda", parent=self.projDialogMasterFileFormat_optMenu)
        cmds.menuItem(label="abc", parent=self.projDialogMasterFileFormat_optMenu)
    ...
    def _build_workshop_files_section(self):
        ...
        cmds.menuItem(label="usd", parent=self.projDialogWorkshopFileFormat_optMenu)
        cmds.menuItem(label="usda", parent=self.projDialogWorkshopFileFormat_optMenu)
        cmds.menuItem(label="abc", parent=self.projDialogWorkshopFileFormat_optMenu)
