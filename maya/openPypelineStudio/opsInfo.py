"""
File: opsInfo.py
Description: Core data retrieval functions for openPypeline Studio. 
             Provides information about projects, paths, versions, and items.
             Refactored from openPipelineInfo.mel (now opsInfo.py) to use modern Python libraries.
"""
...
def get_version_from_file(filename):
    """
    Extracts the 4-digit version padding from an openPypeline Studio filename.
...
def get_file_name(tab, level1, level2, level3, mode, offset=0, archive=0):
    ...
    This dictates openPypeline Studio's file naming conventions.
    ...
    # --- Handle Workshop/Version Discovery Modes ---
        ...
        cmds.warning(f"openPypeline Studio Info: unrecognized file mode '{mode}'")
        return ""
