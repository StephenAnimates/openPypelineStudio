...
class openPypelineMainUI(window.window):
    ...
    def __init__(self):
        ...
        self.width=450
        self.height=780
        self.prettyName = "openPypeline Studio"
    ...
    def _build_currently_open_tab(self):
        ...
        self.op_currOpenMaster_btn = cmds.button('op_currOpenMaster_btn', parent=self.op_currOpen_formLayout, l="MASTER...", w=164, bgc=(.9, .7, .4), c=lambda *args: getattr(self.UIObjects, 'openPypelineSaveMasterGUI').showWindow(), ann=self.anno_master)
